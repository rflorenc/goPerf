...
/* Cria uma fila com prioridade com capacidade para armazenar pdim elementos e armazena a função de comparação dos elementos. Devolve a referência da fila com prioridade criada ou NULL em caso de inexistência de memória ou da função de comparação, ou se pdim for nulo. */
