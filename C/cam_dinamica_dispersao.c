/********* Interface da CAM Dinâmica Por Dispersão Configurada *********/
/***** Nome: cam_dinamica_dispersao.h *****/

#ifndef _CAM_DINAMICA_DISPERSAO
#define _CAM_DINAMICA_DISPERSAO

/******************** Definição da dimensão da CAM ********************/

#define MAX_ELEMENTOS 101
