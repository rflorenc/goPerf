/********** Interface da CAM Dinâmica Logarítmica Configurada **********/
...
/* Cria uma CAM, baseada numa lista skip com pmaxn níveis, e armazena a função de comparação dos elementos. Devolve a referência da CAM criada ou NULL em caso de inexistência de memória ou da função de comparação. */
...
/* Lê o conteúdo do primeiro elemento com a chave indicada, da CAM referenciada por pcam. Valores de retorno: OK, NO_CAM, NULL_PTR, CAM_EMPTY, NO_KEY ou NO_FUNC. */

int CAMReadNext (PtCAM pcam, TELEM *pelem);
/* Lê o conteúdo do elemento seguinte com a chave indicada, da CAM referenciada por pcam. Valores de retorno: OK, NO_CAM, NULL_PTR, CAM_EMPTY, NO_KEY ou NO_FUNC. */
