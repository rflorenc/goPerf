/************* Interface da Fila Semiestática Configurada *************/
/***** Nome: fila_semiestatica.h *****/
...
/* Coloca pelem na cauda da fila referenciada por pqueue. Valores de retorno: OK, NO_QUEUE, QUEUE_FULL ou NO_MEM. */
